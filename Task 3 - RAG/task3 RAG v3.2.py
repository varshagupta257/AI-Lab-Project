...
# REDUCED OVERLAP: Cuts down redundant text bloat processed by the model
...
# OPTIMIZED K: Dropped from 9 to 5 to stop burying the model under 9,000 tokens of text per row
...
# ==========================================
# 3. INITIALIZE OLLAMA WITH MISTRAL
# ==========================================
llm = ChatOllama(
    model="mistral", 
    temperature=0.2, 
...
print(f"\n🚀 Starting streaming batch processing using Mistral via FAISS (k=5)...")
print(f"📁 Clean real-time entries saving directly to: {output_filename}")
print("=" * 70)

# ==========================================
# 5. ROW-BY-ROW STREAMING PROCESS (LOOP PRESERVED)
# ==========================================
...
"""
    ...
    try:
        ...
        # If a true timeout happens, it catches here and seamlessly streams the fallback to the file
        pass 
